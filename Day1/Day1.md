...
thought of as mini-programs that normally you can run on demand (called **calling** the function). `setup()` and
...
part of the function. We will learn about why the parentheses are there when we dive deeper into how functions are
constructed. You can also review this structure in the ***Arduino Structure*** Tinkercad activity.
##
